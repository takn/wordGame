...
class WordGameModelTest {
    ...
    fun testGson() {
        var gson = GsonBuilder()
                .registerTypeAdapter(WordGameModel::class.java,
                        WordGameModelTypeAdapter())
                .create()

        var games = gson.fromJson<List<WordGameModel>>(json, WordGameModel::class.java)
        assertNotNull(games)
    }
